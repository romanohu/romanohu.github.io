...
## My Encounter with wkb Lab: The World of Intellectual Pursuit I-1
At klis, we offer a semester-long course titled "The World of Intellectual Pursuit I-1." This course is taught by wkb-sensei, who serves as supervisor for the wkb Lab. While the [syllabus](https://kdb.tsukuba.ac.jp/syllabi/2025/GE33013/jpn/0/) contains detailed information, in broad terms, it can be summarized as follows:
> [**An Advanced Research Experience Program (ARE) with Stronger Lecture-Based Components**](https://www.are.tsukuba.ac.jp/)
...
- Reading academic papers (specifically papers on multi-agent reinforcement learning and emergent communication fields)
- Conducting research experiments using the provided experimental code
- Participating in regular discussions with the professor and other students in the laboratory
